...
export const termsOfUse = [
  ...
  },
  {
    ...
    text: (
      <View>
        <Bullet>
          Circle or _________ can be acquired for a part or in whole by
          another company. This will be done without (written) notice.
        </Bullet>
        <Bullet>
        ...
        <Bullet>
          ...
          apply. We will adjust these terms of use as necessary, in which case
          the invalid terms will be replaced by valid terms that differ the
          least from the concerned invalid terms.
        </Bullet>
        <Bullet>
        ...
        <Bullet>
          We reserve the right, at our discretion, to make changes to the
          terms of use and privacy policy at any time. The most updated version
          is available on our app. Please check the terms of use and privacy
          policy periodically for changes as all modifications are effective
          upon publication. Continued use of the Circle app after revision
          indicates the user's acceptance of the terms of use.
        </Bullet>
      </View>
    ),
  },
